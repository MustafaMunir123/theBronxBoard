...
SCORE_PROMPT = """#####Questions=> {QUESTION} ### \n#####Actual-Answer=> {ACTUAL_ANSWER} ###\n#####Students-Answer=> {STUDENTS_ANSWER} ###\ncompare Student-Answer with Actual-Answer and assign score out of 5 in format like: {{"score": <SCORE>}}, do not include word json in response and only return valid json with double quotes without any reasoning."""