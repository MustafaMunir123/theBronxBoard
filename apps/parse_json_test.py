...
# Example usage
response = (
    "```\n{\n  \"lesson\": \"Making good choices and being aware of your surroundings can help you stay safe and avoid trouble. Christopher Martinez's 19 arrests show how repeated poor choices can lead to serious consequences. It's essential to respect others' boundaries, make positive decisions, and think about how your actions might affect yourself and others. Staying safe also means being mindful of your environment and avoiding situations that might put you or others at risk.\"\n}\n```"
)
